        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-12">
              ...
              <s-cnt-market-header-nav navBar={this.categories.navBar} selectShops={this.categories.selectShops} leftMenuCatalogArr={this.categories.leftMenuCatalog} ></s-cnt-market-header-nav>
            </div>
          </div>
        </div>
      </div>
