...
export class SCntMarketPromoSliderCard implements ComponentInterface {
  ...
  render() {
    return (
      <div class="promo-slider-card-container">
        <div class="promo-slider-card-content">
          <div class="promo-slider-card-body">
            <div class="promo-slider-card-message">
              <div class="promo-slider-card-message">
                <div class="promo-slider-card-message-header">{this.promoSliderCards.title}</div>
                <div class="promo-slider-card-message-body">{this.promoSliderCards.description}</div>
              </div>
            </div>
          </div>
          <div class="promo-slider-card-logo">
            <div class="promo-slider-card-logo-bg">
              <div class="promo-slider-card-logo-img" style={{backgroundImage: `url(${this.promoSliderCards.img})`}}></div>
            </div>
          </div>
        </div>
      </div>
